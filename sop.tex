...
UC Berkeley stands out due to the number of world-renowned faculties in the area of systems that I would like to work. There are also many projects that are closely aligned to my interest such as TIERS project for developing countries or LoCal project. I would also want to remain in my current research group, since there is definitely interesting energy related issue that is to be explored. I am also attracted by the strength of the undergraduate program in UC Berkeley as I look forward to becoming a teaching assistant again as a graduate student. For these reasons, I believe that the PhD program at UC Berkeley is the best match for my interest. My long term goal is to remain in the academia as a professor, contributing to the research community, undergraduate education and most importantly, the society as a whole. Given my background, I believe that I am in a good position to make crucial contribution in such pursuits. \newline
